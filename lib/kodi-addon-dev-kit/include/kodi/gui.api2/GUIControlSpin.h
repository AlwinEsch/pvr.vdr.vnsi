...
namespace V2
{
  ...
  public:
    ...
    ///
    /// \ingroup CAddonGUIControlSpin
    /// @brief To set the with AddonGUISpinControlType defined types of spin.
    ///
    ...
    ///
    /// Format must be set to ADDON_SPIN_CONTROL_TYPE_TEXT to use this
    /// function.
    ///
    ...
    ///
    /// Format must be set to ADDON_SPIN_CONTROL_TYPE_INT to use this
    /// function.
    ///
    /// @param[in] label                Label string to view on skin
